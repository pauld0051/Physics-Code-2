...
document.getElementById("displacement").onchange = function () {
  ...
  document.getElementById("unitsDistance").disabled = !this.checked;
  document.getElementById("unitsDistance").value = "m";
...
document.getElementById("initial_velocity").onchange = function () {
  ...
  document.getElementById("unitsVi").disabled = !this.checked;
  document.getElementById("unitsVi").value = "ms";
  document.getElementById("inputVi").value = "";
};
document.getElementById("final_velocity").onchange = function () {
  ...
  document.getElementById("unitsVf").disabled = !this.checked;
  document.getElementById("unitsVf").value = "ms";
  document.getElementById("inputVf").value = "";
};
document.getElementById("acceleration").onchange = function () {
  ...
  document.getElementById("aUnits").disabled = !this.checked;
  document.getElementById("aUnits").value = "mss";
  document.getElementById("inputAcceleration").value = "";
};
document.getElementById("time").onchange = function () {
  document.getElementById("inputTime").disabled = !this.checked;
  document.getElementById("inputTime").required = this.checked;
  document.getElementById("unitsTime").disabled = !this.checked;
  document.getElementById("unitsTime").value = "s";
